...
describe MQTT::PacketTypes::Publish do
  describe "when creating a packet" do
    ...
    it "should raise an exception the QoS is less than 0" do
      expect {
        packet = MQTT::PacketTypes::Publish.new( :qos => -1 )
      }.to raise_error(
        'Invalid QoS value: -1'
      )
    end
  ...
  describe "when serialising a packet" do
    it "should output the correct bytes for a packet with default QoS and no flags" do
      packet = MQTT::PacketTypes::Publish.new( :topic => 'test', :payload => 'hello world' )
    ...
    it "should output the correct bytes for a packet with QoS 1 and no flags" do
      packet = MQTT::PacketTypes::Publish.new( :id => 5, :qos => 1, :topic => 'a/b', :payload => 'hello world' )
    ...
    it "should output the correct bytes for a packet with QoS 2 and retain flag set" do
      packet = MQTT::PacketTypes::Publish.new( :id => 5, :qos => 2, :retain => true, :topic => 'c/d', :payload => 'hello world' )
    ...
    it "should output the correct bytes for a packet with QoS 2 and dup flag set" do
      packet = MQTT::PacketTypes::Publish.new( :id => 5, :qos => 2, :duplicate => true, :topic => 'c/d', :payload => 'hello world' )
    ...
    it "should output the correct bytes for a packet with an empty payload" do
      packet = MQTT::PacketTypes::Publish.new( :topic => 'test' )
    ...
    it "should raise an exception when there is an empty topic name" do
      expect {
        MQTT::PacketTypes::Publish.new( :topic => '' ).to_s
      }.to raise_error(
        'Invalid topic name when serialising packet'
      )
    end
  ...
  describe "when serialising an oversized packet" do
    it "should raise an exception when body is bigger than 256MB" do
      expect {
        packet = MQTT::PacketTypes::Publish.new( :topic => 'test', :payload => 'x'*268435455 )
        packet.to_s
      }.to raise_error(
  ...
  describe "when parsing a packet with QoS 0" do
    let(:packet) { MQTT::BasePacket.parse( "\x30\x11\x00\x04testhello world" ) }

    it "should correctly create the right type of packet object" do
      expect(packet.class).to eq(MQTT::PacketTypes::Publish)
    end
  ...
  describe "when parsing a packet with QoS 2 and retain and dup flags set" do
    let(:packet) { MQTT::BasePacket.parse( "\x3D\x12\x00\x03c/d\x00\x05hello world" ) }
  ...
  describe "when parsing a packet with an empty payload" do
    let(:packet) { MQTT::BasePacket.parse( "\x30\x06\x00\x04test" ) }
  ...
  describe "when parsing a packet with a QoS value of 3" do
    it "should raise an exception" do
      expect {
        packet = MQTT::BasePacket.parse( "\x36\x12\x00\x03a/b\x00\x05hello world" )
      }.to raise_error(
  ...
  describe "when parsing a packet with QoS value of 0 and DUP set" do
    it "should raise an exception" do
      expect {
        packet = MQTT::BasePacket.parse( "\x38\x10\x00\x03a/bhello world" )
      }.to raise_error(
        MQTT::ProtocolException,
  ...
  describe "when parsing a packet with a body of 314 bytes" do
    let(:packet) {
      ...
      # 0xC1 = (65 * 1)
      # 0x02 = (2 * 128)
      MQTT::BasePacket.parse( "\x30\xC1\x02\x00\x05topic" + ('x' * 314) )
    }
  ...
  describe "when parsing a packet with a body of 16kbytes" do
    let(:packet) do
      ...
      # 0x80 = (0 * 128)
      # 0x01 = (1 * 16384)
      MQTT::BasePacket.parse( "\x30\x87\x80\x01\x00\x05topic" + ('x'*16384) )
    end
  ...
  describe "processing a packet containing UTF-8 character" do
    ...
    it "should parse the serialised packet" do
      packet2 = MQTT::BasePacket.parse( packet.to_s )
  ...
  describe "reading a packet from a socket" do
    ...
    let(:packet) { MQTT::BasePacket.read(socket) }
  ...
  describe "when calling the inspect method" do
    it "should output the payload, if it is less than 16 bytes" do
      packet = MQTT::PacketTypes::Publish.new( :topic => "topic", :payload => "payload" )
      expect(packet.inspect).to eq("#<MQTT::PacketTypes::Publish: d0, q0, r0, m0, 'topic', 'payload'>")
    end

    it "should output the length of the payload, if it is more than 16 bytes" do
      packet = MQTT::PacketTypes::Publish.new( :topic => "topic", :payload => 'x'*32 )
      expect(packet.inspect).to eq("#<MQTT::PacketTypes::Publish: d0, q0, r0, m0, 'topic', ... (32 bytes)>")
    end

    it "should only output the length of a binary payload" do
      packet = MQTT::BasePacket.parse("\x31\x12\x00\x04test\x8D\xF8\x09\x40\xC4\xE7\x4f\xF0\xFF\x30\xE0\xE7")
      expect(packet.inspect).to eq("#<MQTT::PacketTypes::Publish: d0, q0, r1, m0, 'test', ... (12 bytes)>")
    end
  end
end

describe MQTT::PacketTypes::Connect do
  describe "when serialising a packet" do
    it "should output the correct bytes for a packet with no flags" do
      packet = MQTT::PacketTypes::Connect.new( :client_id => 'myclient' )
    ...
    it "should output the correct bytes for a packet with clean session turned off" do
      packet = MQTT::PacketTypes::Connect.new(
        :client_id => 'myclient',
        :clean_session => false
      )
    ...
    context "protocol version 3.1.0" do
      it "should raise an exception when there is no client identifier" do
        expect {
          MQTT::PacketTypes::Connect.new(:version => '3.1.0', :client_id => '').to_s
        }.to raise_error(
      ...
      it "should raise an exception when the client identifier is too long" do
        expect {
          ...
          MQTT::PacketTypes::Connect.new(:version => '3.1.0', :client_id => client_id).to_s
        }.to raise_error(
    ...
    it "should raise an exception if the keep alive value is less than 0" do
      expect {
        MQTT::PacketTypes::Connect.new(:client_id => 'test', :keep_alive => -2).to_s
      }.to raise_error(
    ...
    context 'protocol version 3.1.1' do
      it "should output the correct bytes for a packet with no flags" do
        packet = MQTT::PacketTypes::Connect.new( :version => '3.1.1', :client_id => 'myclient' )
    ...
    context 'an invalid protocol version number' do
      it "should raise a protocol exception" do
        expect {
          packet = MQTT::PacketTypes::Connect.new( :version => 'x.x.x', :client_id => 'myclient' )
        }.to raise_error(
          ArgumentError,
  ...
  describe "when parsing a simple 3.1.0 Connect packet" do
    let(:packet) do
      MQTT::BasePacket.parse(
        "\x10\x16\x00\x06MQIsdp\x03\x00\x00\x0a\x00\x08myclient"
      )
    end

    it "should correctly create the right type of packet object" do
      expect(packet.class).to eq(MQTT::PacketTypes::Connect)
    end
  ...
  describe "when calling the inspect method" do
    it "should output correct string for the default options" do
      packet = MQTT::PacketTypes::Connect.new
      expect(packet.inspect).to eq("#<MQTT::PacketTypes::Connect: keep_alive=15, clean, client_id=''>")
    end
    ...
    it "should output correct string when parameters are given" do
      ...
      expect(packet.inspect).to eq("#<MQTT::PacketTypes::Connect: keep_alive=10, client_id='c123', username='foo'>")
    end
  end
...
describe MQTT::PacketTypes::Connack do

  describe "when setting attributes on a packet" do
    let(:packet) {  MQTT::PacketTypes::Connack.new }
  ...
  describe "when serialising a packet" do
    it "should output the correct bytes for a sucessful connection acknowledgement packet without Session Present set" do
      packet = MQTT::PacketTypes::Connack.new( :return_code => 0x00, :session_present => false )
    ...
    it "should output the correct bytes for a sucessful connection acknowledgement packet with Session Present set" do
      packet = MQTT::PacketTypes::Connack.new( :return_code => 0x00, :session_present => true )
  ...
  describe "when parsing a successful Connection Accepted packet" do
    let(:packet) do
      MQTT::BasePacket.parse( "\x20\x02\x00\x00" )
    end

    it "should correctly create the right type of packet object" do
      expect(packet.class).to eq(MQTT::PacketTypes::Connack)
    end
  ...
  describe "when parsing a successful Connection Accepted packet with Session Present set" do
    let(:packet) do
      MQTT::BasePacket.parse( "\x20\x02\x01\x00" )
    end
  ...
  describe "when parsing a unacceptable protocol version packet" do
    let(:packet) do
      MQTT::BasePacket.parse( "\x20\x02\x00\x01" )
    end
  ...
  describe "when parsing a client identifier rejected packet" do
    let(:packet) { MQTT::BasePacket.parse( "\x20\x02\x00\x02" ) }
  ...
  describe "when parsing a server unavailable packet" do
    let(:packet) do
      MQTT::BasePacket.parse( "\x20\x02\x00\x03" )
    end
  ...
  describe "when parsing a server unavailable packet" do
    let(:packet) do
      MQTT::BasePacket.parse( "\x20\x02\x00\x04" )
    end
  ...
  describe "when parsing a server unavailable packet" do
    let(:packet) do
      MQTT::BasePacket.parse( "\x20\x02\x00\x05" )
    end
  ...
  describe "when parsing an unknown connection refused packet" do
    let(:packet) { MQTT::BasePacket.parse( "\x20\x02\x00\x10" ) }
  ...
  describe "when parsing packet with invalid Connack flags set" do
    it "should raise an exception" do
      expect {
        packet = MQTT::BasePacket.parse( "\x20\x02\xff\x05" )
      }.to raise_error(
        MQTT::ProtocolException,
  ...
  describe "when parsing packet with extra bytes on the end" do
    it "should raise an exception" do
      expect {
        packet = MQTT::BasePacket.parse( "\x20\x03\x00\x00\x00" )
      }.to raise_error(
        MQTT::ProtocolException,
  ...
  describe "when parsing packet with invalid fixed header flags" do
    it "should raise a protocol exception" do
      expect {
        MQTT::BasePacket.parse( "\x23\x02\x00\x00" )
      }.to raise_error(
        MQTT::ProtocolException,
  ...
  describe "when calling the inspect method" do
    it "should output the right string when the return code is 0" do
      packet = MQTT::PacketTypes::Connack.new( :return_code => 0x00 )
      expect(packet.inspect).to eq("#<MQTT::PacketTypes::Connack: 0x00>")
    end
    it "should output the right string when the return code is 0x0F" do
      packet = MQTT::PacketTypes::Connack.new( :return_code => 0x0F )
      expect(packet.inspect).to eq("#<MQTT::PacketTypes::Connack: 0x0F>")
    end
  end
end

describe MQTT::PacketTypes::Puback do
  describe "when serialising a packet" do
    it "should output the correct bytes for a packet with no flags" do
      packet = MQTT::PacketTypes::Puback.new( :id => 0x1234 )
      expect(packet.to_s).to eq("\x40\x02\x12\x34")
    end
  end

  describe "when parsing a packet" do
    let(:packet) { MQTT::BasePacket.parse( "\x40\x02\x12\x34" ) }

    it "should correctly create the right type of packet object" do
      expect(packet.class).to eq(MQTT::PacketTypes::Puback)
    end
  ...
  describe "when parsing packet with extra bytes on the end" do
    it "should raise an exception" do
      expect {
        packet = MQTT::BasePacket.parse( "\x40\x03\x12\x34\x00" )
      }.to raise_error(
        MQTT::ProtocolException,
  ...
  describe "when parsing packet with invalid fixed header flags" do
    it "should raise a protocol exception" do
      expect {
        MQTT::BasePacket.parse( "\x43\x02\x12\x34" )
      }.to raise_error(
        MQTT::ProtocolException,
  ...
  it "should output the right string when calling inspect" do
    packet = MQTT::PacketTypes::Puback.new( :id => 0x1234 )
    expect(packet.inspect).to eq("#<MQTT::PacketTypes::Puback: 0x1234>")
  end
end

describe MQTT::PacketTypes::Pubrec do
  describe "when serialising a packet" do
    it "should output the correct bytes for a packet with no flags" do
      packet = MQTT::PacketTypes::Pubrec.new( :id => 0x1234 )
      expect(packet.to_s).to eq("\x50\x02\x12\x34")
    end
  end

  describe "when parsing a packet" do
    let(:packet) { MQTT::BasePacket.parse( "\x50\x02\x12\x34" ) }

    it "should correctly create the right type of packet object" do
      expect(packet.class).to eq(MQTT::PacketTypes::Pubrec)
    end
  ...
  describe "when parsing packet with extra bytes on the end" do
    it "should raise an exception" do
      expect {
        packet = MQTT::BasePacket.parse( "\x50\x03\x12\x34\x00" )
      }.to raise_error(
        MQTT::ProtocolException,
  ...
  describe "when parsing packet with invalid fixed header flags" do
    it "should raise a protocol exception" do
      expect {
        MQTT::BasePacket.parse( "\x53\x02\x12\x34" )
      }.to raise_error(
        MQTT::ProtocolException,
  ...
  it "should output the right string when calling inspect" do
    packet = MQTT::PacketTypes::Pubrec.new( :id => 0x1234 )
    expect(packet.inspect).to eq("#<MQTT::PacketTypes::Pubrec: 0x1234>")
  end
end

describe MQTT::PacketTypes::Pubrel do
  describe "when serialising a packet" do
    it "should output the correct bytes for a packet with no flags" do
      packet = MQTT::PacketTypes::Pubrel.new( :id => 0x1234 )
      expect(packet.to_s).to eq("\x62\x02\x12\x34")
    end
  end

  describe "when parsing a packet" do
    let(:packet) { MQTT::BasePacket.parse( "\x62\x02\x12\x34" ) }

    it "should correctly create the right type of packet object" do
      expect(packet.class).to eq(MQTT::PacketTypes::Pubrel)
    end
  ...
  describe "when parsing packet with extra bytes on the end" do
    it "should raise an exception" do
      expect {
        packet = MQTT::BasePacket.parse( "\x62\x03\x12\x34\x00" )
      }.to raise_error(
        MQTT::ProtocolException,
  ...
  describe "when parsing packet with invalid fixed header flags" do
    it "should raise a protocol exception" do
      expect {
        MQTT::BasePacket.parse( "\x60\x02\x12\x34" )
      }.to raise_error(
        MQTT::ProtocolException,
  ...
  it "should output the right string when calling inspect" do
    packet = MQTT::PacketTypes::Pubrel.new( :id => 0x1234 )
    expect(packet.inspect).to eq("#<MQTT::PacketTypes::Pubrel: 0x1234>")
  end
end

describe MQTT::PacketTypes::Pubcomp do
  describe "when serialising a packet" do
    it "should output the correct bytes for a packet with no flags" do
      packet = MQTT::PacketTypes::Pubcomp.new( :id => 0x1234 )
      expect(packet.to_s).to eq("\x70\x02\x12\x34")
    end
  end

  describe "when parsing a packet" do
    let(:packet) { MQTT::BasePacket.parse( "\x70\x02\x12\x34" ) }

    it "should correctly create the right type of packet object" do
      expect(packet.class).to eq(MQTT::PacketTypes::Pubcomp)
    end
  ...
  describe "when parsing packet with extra bytes on the end" do
    it "should raise an exception" do
      expect {
        MQTT::BasePacket.parse( "\x70\x03\x12\x34\x00" )
      }.to raise_error(
        MQTT::ProtocolException,
  ...
  describe "when parsing packet with invalid fixed header flags" do
    it "should raise a protocol exception" do
      expect {
        MQTT::BasePacket.parse( "\x72\x02\x12\x34" )
      }.to raise_error(
        MQTT::ProtocolException,
  ...
  it "should output the right string when calling inspect" do
    packet = MQTT::PacketTypes::Pubcomp.new( :id => 0x1234 )
    expect(packet.inspect).to eq("#<MQTT::PacketTypes::Pubcomp: 0x1234>")
  end
end

describe MQTT::PacketTypes::Subscribe do
  describe "setting the packet's topics" do
    let(:packet)  { MQTT::PacketTypes::Subscribe.new }
  ...
  describe "when serialising a packet" do
    it "should output the correct bytes for a packet with a single topic" do
      packet = MQTT::PacketTypes::Subscribe.new( :id => 1, :topics => 'a/b' )
    ...
    it "should output the correct bytes for a packet with multiple topics" do
      packet = MQTT::PacketTypes::Subscribe.new( :id => 6, :topics => [['a/b', 0], ['c/d', 1]] )
    ...
    it "should raise an exception when no topics are given" do
      expect {
        MQTT::PacketTypes::Subscribe.new.to_s
      }.to raise_error(
  ...
  describe "when parsing a packet with a single topic" do
    let(:packet) { MQTT::BasePacket.parse( "\x82\x08\x00\x01\x00\x03a/b\x00" ) }

    it "should correctly create the right type of packet object" do
      expect(packet.class).to eq(MQTT::PacketTypes::Subscribe)
    end
  ...
  describe "when parsing a packet with a two topics" do
    let(:packet) { MQTT::BasePacket.parse( "\x82\x0e\000\x06\x00\x03a/b\x00\x00\x03c/d\x01" ) }
  ...
  describe "when parsing packet with invalid fixed header flags" do
    it "should raise a protocol exception" do
      expect {
        MQTT::BasePacket.parse( "\x80\x08\x00\x01\x00\x03a/b\x00" )
      }.to raise_error(
        MQTT::ProtocolException,
  ...
  describe "when calling the inspect method" do
    it "should output correct string for a single topic" do
      packet = MQTT::PacketTypes::Subscribe.new(:topics => 'test')
      expect(packet.inspect).to eq("#<MQTT::PacketTypes::Subscribe: 0x00, 'test':0>")
    end

    it "should output correct string for multiple topics" do
      packet = MQTT::PacketTypes::Subscribe.new(:topics => {'a' => 1, 'b' => 0, 'c' => 2})
      expect(packet.inspect).to eq("#<MQTT::PacketTypes::Subscribe: 0x00, 'a':1, 'b':0, 'c':2>")
    end
  end
end

describe MQTT::PacketTypes::Suback do
  describe "when serialising a packet" do
    it "should output the correct bytes for an acknowledgement to a single topic" do
      packet = MQTT::PacketTypes::Suback.new( :id => 5, :return_codes => 0 )
      expect(packet.to_s).to eq("\x90\x03\x00\x05\x00")
    end

    it "should output the correct bytes for an acknowledgement to a two topics" do
      packet = MQTT::PacketTypes::Suback.new( :id => 6 , :return_codes => [0,1] )
      expect(packet.to_s).to eq("\x90\x04\x00\x06\x00\x01")
    end

    it "should raise an exception when no granted QoSs are given" do
      expect {
        MQTT::PacketTypes::Suback.new( :id => 7 ).to_s
      }.to raise_error(
    ...
    it "should raise an exception if the granted QoS is not an integer" do
      expect {
        MQTT::PacketTypes::Suback.new( :id => 8, :return_codes => :foo ).to_s
      }.to raise_error(
  ...
  describe "when parsing a packet with a single QoS value of 0" do
    let(:packet) { MQTT::BasePacket.parse( "\x90\x03\x12\x34\x00" ) }

    it "should correctly create the right type of packet object" do
      expect(packet.class).to eq(MQTT::PacketTypes::Suback)
    end
  ...
  describe "when parsing a packet with two QoS values" do
    let(:packet) { MQTT::BasePacket.parse( "\x90\x04\x12\x34\x01\x01" ) }
  ...
  describe "when parsing packet with invalid fixed header flags" do
    it "should raise a protocol exception" do
      expect {
        MQTT::BasePacket.parse( "\x92\x03\x12\x34\x00" )
      }.to raise_error(
        MQTT::ProtocolException,
  ...
  describe "when calling the inspect method" do
    it "should output correct string for a single granted qos" do
      packet = MQTT::PacketTypes::Suback.new(:id => 0x1234, :return_codes => 0)
      expect(packet.inspect).to eq("#<MQTT::PacketTypes::Suback: 0x1234, rc=0x00>")
    end

    it "should output correct string for multiple topics" do
      packet = MQTT::PacketTypes::Suback.new(:id => 0x1235, :return_codes => [0,1,2])
      expect(packet.inspect).to eq("#<MQTT::PacketTypes::Suback: 0x1235, rc=0x00,0x01,0x02>")
    end
  end
...
describe MQTT::PacketTypes::Unsubscribe do
  describe "when serialising a packet" do
    it "should output the correct bytes for a packet with single topic" do
      packet = MQTT::PacketTypes::Unsubscribe.new( :id => 5, :topics => 'a/b' )
      expect(packet.to_s).to eq("\xa2\x07\x00\x05\x00\x03a/b")
    end

    it "should output the correct bytes for a packet with multiple topics" do
      packet = MQTT::PacketTypes::Unsubscribe.new( :id => 6, :topics => ['a/b','c/d'] )
      expect(packet.to_s).to eq("\xa2\x0c\000\006\000\003a/b\000\003c/d")
    end

    it "should raise an exception when no topics are given" do
      expect {
        MQTT::PacketTypes::Unsubscribe.new.to_s
      }.to raise_error(
        'no topics given when serialising packet'
      )
    end
  ...
  describe "when parsing a packet" do
    let(:packet) { MQTT::BasePacket.parse( "\xa2\f\000\005\000\003a/b\000\003c/d" ) }

    it "should correctly create the right type of packet object" do
      expect(packet.class).to eq(MQTT::PacketTypes::Unsubscribe)
    end
  ...
  describe "when parsing packet with invalid fixed header flags" do
    it "should raise a protocol exception" do
      expect {
        MQTT::BasePacket.parse( "\xa0\x07\x00\x05\x00\x03a/b" )
      }.to raise_error(
        MQTT::ProtocolException,
  ...
  describe "when calling the inspect method" do
    it "should output correct string for a single topic" do
      packet = MQTT::PacketTypes::Unsubscribe.new(:topics => 'test')
      expect(packet.inspect).to eq("#<MQTT::PacketTypes::Unsubscribe: 0x00, 'test'>")
    end

    it "should output correct string for multiple topics" do
      packet = MQTT::PacketTypes::Unsubscribe.new( :id => 42, :topics => ['a', 'b', 'c'] )
      expect(packet.inspect).to eq("#<MQTT::PacketTypes::Unsubscribe: 0x2A, 'a', 'b', 'c'>")
    end
  end
end

describe MQTT::PacketTypes::Unsuback do
  describe "when serialising a packet" do
    it "should output the correct bytes for a packet with no flags" do
      packet = MQTT::PacketTypes::Unsuback.new( :id => 0x1234 )
  ...
  describe "when parsing a packet" do
    let(:packet) do
      MQTT::BasePacket.parse( "\xB0\x02\x12\x34" )
    end

    it "should correctly create the right type of packet object" do
      expect(packet.class).to eq(MQTT::PacketTypes::Unsuback)
    end
  ...
  describe "when parsing packet with extra bytes on the end" do
    it "should raise an exception" do
      expect {
        packet = MQTT::BasePacket.parse( "\xB0\x03\x12\x34\x00" )
      }.to raise_error(
        MQTT::ProtocolException,
  ...
  describe "when parsing packet with invalid fixed header flags" do
    it "should raise a protocol exception" do
      expect {
        MQTT::BasePacket.parse( "\xB2\x02\x12\x34" )
      }.to raise_error(
        MQTT::ProtocolException,
  ...
  it "should output the right string when calling inspect" do
    packet = MQTT::PacketTypes::Unsuback.new( :id => 0x1234 )
    expect(packet.inspect).to eq("#<MQTT::PacketTypes::Unsuback: 0x1234>")
  end
end

describe MQTT::PacketTypes::Pingreq do
  describe "when serialising a packet" do
    it "should output the correct bytes for a packet with no flags" do
      packet = MQTT::PacketTypes::Pingreq.new
  ...
  describe "when parsing a packet" do
    it "should correctly create the right type of packet object" do
      packet = MQTT::BasePacket.parse( "\xC0\x00" )
      expect(packet.class).to eq(MQTT::PacketTypes::Pingreq)
    end

    it "should raise an exception if the packet has a payload" do
      expect {
        MQTT::BasePacket.parse( "\xC0\x05hello" )
      }.to raise_error(
  ...
  it "should output the right string when calling inspect" do
    packet = MQTT::PacketTypes::Pingreq.new
    expect(packet.inspect).to eq("#<MQTT::PacketTypes::Pingreq>")
  end
end

describe MQTT::PacketTypes::Pingresp do
  describe "when serialising a packet" do
    it "should output the correct bytes for a packet with no flags" do
      packet = MQTT::PacketTypes::Pingresp.new
  ...
  describe "when parsing a packet" do
    it "should correctly create the right type of packet object" do
      packet = MQTT::BasePacket.parse( "\xD0\x00" )
      expect(packet.class).to eq(MQTT::PacketTypes::Pingresp)
    end

    it "should raise an exception if the packet has a payload" do
      expect {
        MQTT::BasePacket.parse( "\xD0\x05hello" )
      }.to raise_error(
  ...
  it "should output the right string when calling inspect" do
    packet = MQTT::PacketTypes::Pingresp.new
    expect(packet.inspect).to eq("#<MQTT::PacketTypes::Pingresp>")
  end
end


describe MQTT::PacketTypes::Disconnect do
  describe "when serialising a packet" do
    it "should output the correct bytes for a packet with no flags" do
      packet = MQTT::PacketTypes::Disconnect.new
  ...
  describe "when parsing a packet" do
    it "should correctly create the right type of packet object" do
      packet = MQTT::BasePacket.parse( "\xE0\x00" )
      expect(packet.class).to eq(MQTT::PacketTypes::Disconnect)
    end

    it "should raise an exception if the packet has a payload" do
      expect {
        MQTT::BasePacket.parse( "\xE0\x05hello" )
      }.to raise_error(
  ...
  it "should output the right string when calling inspect" do
    packet = MQTT::PacketTypes::Disconnect.new
    expect(packet.inspect).to eq("#<MQTT::PacketTypes::Disconnect>")
  end
end
...
describe "Serialising an invalid packet" do
  context "that has a no type" do
    it "should raise an exception" do
      expect {
        MQTT::BasePacket.new.to_s
      }.to raise_error(
        RuntimeError,
        "Invalid packet type: MQTT::BasePacket"
      )
    end
  end
end
...
describe "Parsing an invalid packet" do
  ...
  context "that has too many bytes in the length field" do
    it "should raise an exception" do
      expect {
        MQTT::BasePacket.parse( "\x30\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF" )
      }.to raise_error(
        MQTT::ProtocolException,
        'Failed to parse packet - input buffer (4) is not the same as the body length header (268435455)'
      )
  ...
  context "that has a bigger buffer than expected" do
    it "should raise an exception" do
      expect {
        MQTT::BasePacket.parse( "\x30\x11\x00\x04testhello big world" )
      }.to raise_error(
        MQTT::ProtocolException,
  ...
  context "that has a smaller buffer than expected" do
    it "should raise an exception" do
      expect {
        MQTT::BasePacket.parse( "\x30\x11\x00\x04testhello" )
      }.to raise_error(
        MQTT::ProtocolException,
